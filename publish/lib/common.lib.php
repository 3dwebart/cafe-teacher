...
function get_paging($write_pages, $cur_page, $total_page, $url, $add="") {
    ...
    $str = '';
    if ($cur_page > 1) {
        $str .= '<a href="'.$url.'1'.$add.'" class="pg_page pg_start"><i class="fa fa-fast-backward" aria-hidden="true"></i><span class="sound_only">처음</span></a>'.PHP_EOL;
    }
    ...
    if ($start_page > 1) $str .= '<a href="'.$url.($start_page-1).$add.'" class="pg_page pg_prev"><i class="fa fa-step-backward" aria-hidden="true"></i><span class="sound_only">이전</span></a>'.PHP_EOL;
    ...
    if ($total_page > $end_page) $str .= '<a href="'.$url.($end_page+1).$add.'" class="pg_page pg_next"><i class="fa fa-step-forward" aria-hidden="true"></i><span class="sound_only">다음</span></a>'.PHP_EOL;

    if ($cur_page < $total_page) {
        $str .= '<a href="'.$url.$total_page.$add.'" class="pg_page pg_end"><i class="fa fa-fast-forward" aria-hidden="true"></i><span class="sound_only">맨끝</span></a>'.PHP_EOL;
    }
